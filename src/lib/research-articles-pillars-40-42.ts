...
const sources: ResearchSource[] = [
  ...
  { title: "地域包括ケアシステム", url: "https://www.mhlw.go.jp/stf/seisakunitsuite/bunya/hukushi_kaigo/kaigo_koureisha/chiiki-houkatsu/index.html", publisher: "厚生労働省", accessed, note: "住まい・医療・介護・予防・生活支援を統合する方針枠組み。" },
  { title: "地域共生社会の推進", url: "https://www.mhlw.go.jp/stf/seisakunitsuite/bunya/hukushi_kaigo/seikatsuhogo/chiikikyosei/index.html", publisher: "厚生労働省", accessed, note: "属性別制度を越える包括的支援の方針資料。" },
...
const elderSections = [
  ...
  { heading: "2　生活圏・移動・境内アクセス", paragraphs: [
    ...
    "磐田市内96寺を調べる場合、地区、人口密度、バス停距離、坂、駐車場、室内利用可否を同じ調査票へ登録する。ただし公開情報が防犯や寺務へ影響する場合は精度を下げる。寺院が遠い地区では、公会堂や医療機関の方が適切な拠点になり得る。寺院活用を目的化せず、生活圏ごとに既存施設の重複と空白を比較することが方針的に重要である。",
  ]},
...
const vacantSections = [
  { heading: "1　空き家問題を寺院周辺の住宅方針として読む", paragraphs: [
  ...
  { heading: "5　寺院周辺の空き家を面的に分析する", paragraphs: [
    "空き家を1棟ずつ処理しても、商店、交通、医療、農地、墓地が失われれば居住継続は難しい。寺院から徒歩圏の世帯数、空き家、公共交通、買物、診療、避難所を地図化し、生活圏単位で方針を考える。個別住所は非公開とし、100mメッシュ等へ集約する。寺院立地を中心に固定せず、住民が実際に使う施設を同じ重みで置く。",
    ...
    "寺院の法要圏と空き家分布を重ねる研究には倫理的注意が要る。檀家世帯の所在地を公開せず、地区集計に匿名化する。寺院関係が薄い世帯も含む行政統計と比較し、檀家減少を人口減少の代理変数にしない。長期的には空き家発生年、管理状態、利用再開、除却を追跡し、売買件数だけで方針成果を評価しない。",
  ]},
  { heading: "6　結論――宗教的信頼と住宅取引を分離する", paragraphs: [
    ...
    "最終的には福祉、法務、建築、住宅流通、墓地・仏壇の相談経路を1枚に整理しつつ、契約は分離する。高齢者本人が住み続ける選択を空き家予防の名で妨げず、死亡後の家族へ即時処分を迫らない。住まいを資産だけでなく生活史として尊重しながら、周辺安全と所有者責任を明確にすることが磐田の寺院周辺住宅方針に求められる。",
    disclosure,
  ]},
];
...
vacantSections[5].paragraphs.splice(-1, 0,
  ...
  "空き家バンクの掲載数や成約数は方針成果の一部にすぎない。市場に出にくい低需要物件、所有者不明、危険物件が母集団から外れるためである。相談から登録までの脱落理由、管理改善、賃貸継続、再空き家化を追跡する。成約後の居住者と地域の関係を調べる際も、移住者を寺院活動へ参加させることを定着条件にしない。",
  ...
  "面的方針の評価期間は短期成約ではなく10年以上が望ましい。発生予防、管理改善、再利用、除却、跡地管理を年ごとに追い、地区人口や住宅需要の変化を補正する。寺院を情報拠点にした地区としない地区を比較し、早期相談に差があるかを見る。差がなければ寺院活用を縮小し、行政広報などより有効な方法へ資源を移す。",
  ...
  "空き家除却後の土地は問題が消えるとは限らない。雑草、排水、駐車、資材置場、境界、固定資産税、土地需要を管理する必要がある。寺院行事用駐車場への転用も近隣騒音、舗装、雨水、交通安全、都市計画を確認する。除却件数で方針を完了とせず、5年後の跡地利用を追跡する。",
...
const vacantArticle = makeArticle(
  ...
  ["磐田", "寺院", "空き家", "相続登記", "管理不全空家", "住宅方針"], vacantSections, vacantFigures,
);
