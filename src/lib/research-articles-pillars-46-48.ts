...
const archiveSources: ResearchSource[] = [
  ...
  source("国立公文書館デジタルアーカイブ推進要綱", "https://www.archives.go.jp/about/report/pdf/youkou.pdf", "国立公文書館", "デジタル化、保存、利用、記述方式の方針的枠組みを確認。"),
...
const traditionSections: { heading: string; paragraphs: string[] }[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "磐田における新たな知見は、梵鐘・門・供養塔・案内板・地誌を同一の確度で並べず、物証と語りの成立を交差させることで得られる。伝承の一部が裏付けられるときも、残りを自動承認しない。裏付けられない部分は、後代の記憶方針として研究する。",
