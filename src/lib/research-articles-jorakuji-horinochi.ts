...
const networkCore = [
  ...
  "常楽寺と東福寺が同じ堀之内に近接して成立した背景には、村落人口、檀家分布、地形、葬送圏の分化が考えられる。だが1590年時点の人口や家数を、1718年の家数48・人数239から逆算することはできない。新寺創立が人口増加、集落分立、領主方針、宗派布教のどれに対応したかは未確定である。字水洗と字蔵山の位置、古道、墓地、寺領、天白神社を地図化し、2寺が異なる小集落や機能を担ったかを調べる。",
