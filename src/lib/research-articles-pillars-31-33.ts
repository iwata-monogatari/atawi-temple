...
ieyasuSections[5].paragraphs.splice(-1, 0,
  ...
  "伊奈忠次の活動を家康の代理と表現する際も、個別文書に命令関係が記されるかを確認する。代官・奉行としての裁量、地域調査、寺社方針があり得るため、すべてを家康の直接意思へ還元しない。伊奈署判文書の様式、同日発給先、対象村を比較すれば、特定寺院への恩賞か、広域方針の一部かを判断できる。家臣行政を可視化することは家康の役割を弱めるのではなく、統治が組織によって実行された実態を示す。",
  ...
  "地域比較のため、浜松城周辺、掛川、遠州の他地域に残る家康寺領・梵鐘・御殿門を参照する。同形式の寄進が広く行われたなら磐田事例は方針の地域適用として、稀なら個別事情として位置付けられる。ただし他地域の伝承も同じ証拠階層で評価し、有名な解説を比較基準にしない。磐田だけを特別視せず、遠江統治の中で固有性を測る。",
