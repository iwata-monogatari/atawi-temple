...
const conversionTexts = [
  ...
  "1588年7月の火災は宗寿寺の堂宇を焼失させたと郡誌が伝える。出火原因、被害範囲、死傷者、仏像・文書の焼失、仮堂の設置時期は不明である。火災が転宗・改号の直接原因だったという物語は自然に見えるが、再興までの期間が不明なため因果は確定できない。火災前に曹洞宗僧との関係が始まっていた可能性、焼失後も密宗の小堂が継続した可能性、後世の再興譚が複数の出来事を1つへ圧縮した可能性を競合仮説とする。焼土層・炭化材・礎石の考古学的調査、火災年銘の位牌・供養塔、村方日記、近隣寺院記録を探す。1588年は豊臣政権期の遠江支配再編と重なるが、政治変動を火災原因や転宗方針へ直結させる史料はない。広域史は背景として提示し、寺院個別の寄進状・禁制・寺領安堵が確認された場合にのみ因果を論じる。",
