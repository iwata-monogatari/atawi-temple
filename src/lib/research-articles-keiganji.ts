...
const keiganjiLandscapeArticle: ResearchArticle = {
  ...
  description: "見付町字倉小路に所在した慶岩寺を起点に、宿場の小路、寺院群、書院と境内、年中行事、近代教育・景観方針を都市宗教史として分析する。",
  published: "2026-07-24",
  updated: "2026-07-24",
  verificationStatus: "公開資料による検証済み",
  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        "本稿は都市宗教空間を4つの関係で分析する。第1は慶岩寺と小路・旧東海道の接続、第2は見付九山を含む寺院相互の配置、第3は本堂・地蔵堂・書院・境内が担う内部機能、第4は年中行事と参詣者が作る時間的な都市利用である。これらに近代教育と現代景観方針を加え、寺院が都市の変化へどう適応したかを検討する。",
      ],
      figure: figures.grounds,
    },
    {
