...
export const daijoinHistoryArticle: ResearchArticle = {
  ...
  description: "大乗院と小笠寺が1境内へ統合された過程を、寺伝、修験道制度、中泉御殿、近代宗教方針、現行法人情報から再構成する。",
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "明治政府は1872年に修験道を廃止し、修験者を天台・真言両宗へ帰属させる方針を進めた。大乗院公式資料は、廃仏毀釈の影響で約30年間寺格を失い、一時廃寺となったと説明する。この期間を単なる衰退と呼ぶだけでは不十分である。法人制度が整う以前の寺格、堂宇の所有者、本尊の保管、旧信者組織、祭礼の継続状況を確認する必要がある。修験組織が制度上解体されても、尊像、土地、地域記憶の全てが同時に消えたとは限らない。断絶の内容を機能ごとに分けることが重要である。",
        ...
        "小笠寺も修験道廃止後に寺格を失い、大正期に再興されたと伝わる。1942年に小笠寺が大乗院へ合併し、現在の形になった。戦時下の宗教法人統合方針、住職継承、財産管理、地域側の意向が合併へどう影響したかは未確認である。しかし合併後も三仭坊名、本尊、堂宇が保持されたことから、吸収による完全消滅ではなく、法人格を大乗院へ集約しながら小笠寺の信仰資産を内部保存した形と評価できる。",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "以上より、大乗院三仭坊は、古墳上の立地、修験道制度、中泉の政治史、近代宗教方針を同時に考察できる複合寺院である。その価値は「全国でも珍しい2寺1境内」という希少性だけでなく、制度的断絶の後に2つの寺号と本尊を再編し、現代の宗教法人と実践へ接続した過程にある。直線的な古刹史から複数層の制度史へ記述を改めることで、中泉という都市空間が宗教施設をどのように保存し直したかが明瞭になる。",
      ],
    },
  ],
  sources,
