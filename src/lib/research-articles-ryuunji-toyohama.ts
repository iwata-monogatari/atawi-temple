...
const founderCore = [
  ...
  "1578年は戦国末期に当たるが、一般的な政治史から竜雲寺の創立理由を導いてはならない。海岸低地の村落再編、曹洞宗布教、葬送需要、領主方針など複数背景が考えられるものの、直接史料が必要である。創立とは、草庵設置、寺号公称、本尊安置、境内地取得、檀家形成、本寺承認が同時とは限らない。郡誌の「開創」を要素へ分解し、どの行為に1578年7月6日が対応するかを調べる。日付が開山忌に由来する可能性も検討する。",
