...
const chronology: ResearchArticle = {
  ...
  sections: [
    ...
    { heading: "2　1582年4月1日と「一宇新築」の史料批判", paragraphs: [
      ...
      "本能寺の変と同年であることは時代の目印に過ぎず、福生寺創建との因果関係を示さない。遠江の政治変動、徳川支配、村落形成を背景として論じる場合も、寺地寄進、領主文書、檀越名、寺社方針が当寺へ直接接続する資料を求める。全国史上の事件で地域資料の空白を埋めない。",
