...
const foundingExpansions = [
  ...
  "近代宗派史は、1941年合同だけを転換点とせず、1870年代以後の宗派公称、1898年の顕本法華宗改称、戦時宗教方針、戦後の宗教法人制度を連続的に追う必要がある。玄妙寺が各時点でどの宗制上の地位を持ち、貫首選任、末寺関係、財産管理、教育にどの変化があったかを宗門公報と寺院文書で確認する。「什門4本山」という戦後の呼称も、構成寺院と使用開始年を一次資料で確定するべきである。2013年慶讃法要で准宗宝の曼荼羅・日什像が修復され、客殿庫裡が落慶したとの報道は、祖師記憶、文化財保存、教化施設整備が一体で進む現代本山の機能を示す。参列者数は行事規模の資料だが、信仰人口全体の統計へ拡大しない。",
