...
const chronologyCore = [
  ...
  "1601年は徳川期初頭、1619年は幕藩体制形成期にあたるが、政治史の節目と近いだけで寺院成立を方針の直接結果としない。宮之一色村の検地、村高、寺社領、正医寺門末形成を同時期資料から調べ、黒印と草創が村落制度のどの段階に置かれたかを検討する。黒印が既存堂庵を対象とし、1619年が曹洞宗寺院としての再編を示す仮説は有力でも未証明である。",
...
const mergerCore = [
  ...
  "1874年という時期は明治初期の宗教行政変動に近いが、全国方針一般をそのまま地蔵寺の合併理由にしない。合併願、県令、寺院明細帳、宗派改帳、村会記録、正医寺・松向庵文書を探し、誰が申請し、どの行政主体が認可し、どの資産をどう処理したか確認する。地蔵寺が無住、破損、檀家減少、方針整理のどれであったかは、文書なしに選べない。",
