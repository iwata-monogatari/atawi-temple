...
export const jurinjiNetworkArticle: ResearchArticle = {
  ...
  sections: [
    ...
    { heading: "4　閻魔像の国分寺・十輪寺・連福寺間移動", paragraphs: [
      ...
      "明治初年の移動は神仏分離、廃寺、管理変更と関係した可能性があるが、運搬理由を方針だけで断定しない。受渡文書、台座銘、寺院記録を探す。",
...
const networkFurtherAnalysis = [
  ...
  "閻魔像が国分寺から十輪寺を経て1881年に連福寺へ移ったという地域伝承は、廃寺後の文化財救済を考える貴重な仮説を提供する。だが、同一像であることを確定するには、各段階の像名、寸法、材質、姿勢、眷属、台座、銘文、損傷を比較する必要がある。国分寺の衰退、明治初年の宗教方針、1881年という移動年を結び付ける際も、方針が直接の原因だったと決めず、堂宇の安全性、管理者、地域講、修理事情を調べる。連福寺側の台帳、縁起、修理記録、新聞、旧写真に十輪寺の記載があれば伝承の強度は上がる。十輪寺における安置場所が不明な間は、本堂、閻魔堂、仮置場のいずれかを断定しない。この像の経路は単なる移送ではなく、消滅の危機にあった宗教遺産を複数寺院が時間差で支えた可能性として提示する。",
