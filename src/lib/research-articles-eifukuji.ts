...
const historyArticle: ResearchArticle = {
  ...
  sections: [
    ...
    { heading: "2　1504年開創・金室竜公・命泉義竜", paragraphs: [
      ...
      "勧請開山は、実際の常住・普請担当とは別に、法系上の権威ある僧を開山として仰ぐ制度になり得る。命泉義竜が福王寺2世であったこと、金室竜公との師資関係、永福寺の最初の常住、法灯継承を宗門資料で確認し、「2世」を現代の単純な就任順へ読み替えない。福王寺が1444年に曹洞宗として再興されたとの寺伝と1504年の永福寺開創には60年の差があるが、この近接だけで末寺開設方針を断定しない。",
