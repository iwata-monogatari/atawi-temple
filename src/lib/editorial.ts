...
// キャンペーン名は ATAWI SHRINE 側（utm_campaign=jikka_karte）と揃える。
export function jikkaKarteUrl(content?: string) {
  return campaignUrl(FUDOSAN_FROM_TEMPLE_URL, "jikka_karte", content);
}
...
export const guideArticles: EditorialArticle[] = [
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer: "先に菩提寺や墓地の関係を確認する方が安全です。家族の合意、寺院との関係、墓地の管理者を分けて確認してから進めます。",
      },
    ],
    sources: [
      {
        title: "ATAWI TEMPLE 寺院検索",
        url: "/search/",
        note: "磐田市内寺院の名称、住所、地区、宗派から候補を探す入口。",
      },
      {
        title: "ATAWI TEMPLE 編集方針",
        url: "/editorial-policy/",
        note: "未確認情報を推測せず、公式・公的資料と現地確認を優先する方針を参照。",
      },
    ],
    bridgeLinks: [
      { label: "寺院名・地区で検索する", href: "/search/", event: "temple_search_refine" },
  ...
  {
    slug: "haka-enpo",
    title: "墓じまい前に確認すること｜寺・実家・不動産",
    subtitle: "菩提寺、墓地、親族、仏壇、実家の状態を、結論の前に分けて確認します。",
    description: "磐田市で墓じまいを考える前に、菩提寺、墓地管理者、親族の合意、仏壇・位牌、実家の名義や空き家状態を確認する順番を整理します。",
    category: "お墓と実家",
    updated: "2026-07-20",
    priority: "P0",
    sections: [
      {
        heading: "墓じまいは、片付けだけの話ではありません",
        paragraphs: [
      ...
      },
      {
        ...
        cta: {
          label: "実家・お墓まわりの確認だけ相談する",
          href: fromTempleUrl("haka_jimai_check"),
          event: "to_fudosan_click",
          note: "査定ではありません。墓、仏壇、実家、土地資料を分けて確認するための入口です。",
          external: true,
        },
        note: "運営元の不動産サービスへ移動します。掲載寺院との提携・紹介関係はありません。",
      },
    ...
    faq: [
      {
        question: "墓じまいを考える場合、最初に誰へ相談すべきですか。",
        answer: "菩提寺または墓地管理者、親族の順に確認します。費用や業者選びの前に、墓地の権利関係、遺骨の行き先、家族の合意を整理します。",
      },
      {
        question: "墓じまいと実家の相談は同時にしてよいですか。",
        answer: "同時に整理して構いません。お墓、仏壇、位牌、実家の管理は家族の話し合いではつながりやすいため、写真と資料を同じフォルダにまとめておくと便利です。",
      },
      {
        question: "菩提寺が分からない場合はどうすればよいですか。",
        answer: "仏壇、過去帳、寺からの封筒、墓地の場所、親族の記憶から順番に確認します。候補を推測で断定せず、寺院検索や地区情報で絞り込みます。",
      },
    ],
    sources: [
      {
  ...
  {
    slug: "butsudan-haka-jimai",
    title: "仏壇じまいと墓じまいの手順｜菩提寺への相談の仕方",
    subtitle: "閉眼供養の頼み方、進める順番、神棚との相談先の違いを整理します。",
    description: "実家をたたむときの寺側の作法を整理します。仏壇じまいと墓じまいは別の手続きで、呼び名も宗派によって異なります。菩提寺への切り出し方、閉眼供養、改葬許可の順番を、結論を急がずに確認します。",
    category: "仏壇とお墓",
    updated: "2026-08-13",
    sections: [
      {
        heading: "仏壇と墓は、別々の手続きです",
        paragraphs: [
      ...
      {
        heading: "閉眼供養は、宗派によって呼び名も考え方も違います",
        paragraphs: [
        ...
        note: "法要の名称、必要性、営み方は宗派・寺院・地域で異なります。当サイトの説明だけで判断せず、菩提寺へ確認してください。",
      },
      {
        heading: "菩提寺へは、やめる話から入らない",
        paragraphs: [
      ...
      {
        heading: "神棚がある家は、相談先が分かれます",
        paragraphs: [
          "仏壇と神棚の両方がある家は珍しくありません。仏壇は寺、神棚は神社と、相談先が分かれます。同じ日に片づける場合でも、それぞれに連絡することになります。",
          "神棚じまいやお神札の納め方については、姉妹サイトのATAWI SHRINEで整理しています。",
        ],
        cta: {
          label: "神棚じまいと氏神への挨拶を見る",
          href: "https://shrine.atawi.link/manners/mn026-jikka-jimai/",
          event: "shrine_bridge_click",
          note: "姉妹サイトATAWI SHRINEの記事へ移動します。",
        },
      },
      {
        heading: "実家の整理は、同じ時期に重なります",
        paragraphs: [
        ...
        cta: {
          label: "実家について分かっていることを記録する",
          href: fromTempleUrl("butsudan_haka_jimai"),
          event: "to_fudosan_click",
          note: "売却や査定を前提とした記録ではありません。",
          external: true,
        },
      },
    ],
    faq: [
      {
        question: "仏壇を片づけるとき、必ず法要が必要ですか。",
        answer: "必要かどうか、どのような法要になるかは宗派と寺院によって異なります。閉眼供養、遷仏法要など呼び名も分かれるため、菩提寺へ確認してください。菩提寺が分からない場合は、位牌や過去帳、寺からの封筒などから順に調べます。",
      },
      {
        question: "墓じまいに役所の手続きは要りますか。",
        answer: "遺骨を別の場所へ移す場合は、墓地のある市町村長の改葬許可が必要です。必要書類や様式は自治体によって異なるため、墓地のある市町村の公式案内で確認してください。",
      },
      {
        question: "仏壇と墓を同時に進めた方がよいですか。",
        answer: "同時である必要はありません。同じ菩提寺であれば一度に相談できますが、実際の作業は片方ずつでも構いません。急いで両方を決めると、位牌や遺骨の行き先が後回しになりやすくなります。",
      },
      {
        question: "お布施はいくら包めばよいですか。",
        answer: "お布施に定価はなく、法要の内容、地域の慣習、寺院との関係によって異なります。家の過去の記録を確認し、分からない場合は「これまでどのようにしていたか分からないので、失礼のない形を教えてください」と菩提寺へ直接伺って構いません。",
      },
    ],
    sources: [
      {
        title: "厚生労働省「墓地、埋葬等に関する法律の概要」",
        url: "https://www.mhlw.go.jp/stf/seisakunitsuite/bunya/0000130181.html",
        note: "埋葬・改葬の許可制度を確認する一次情報。",
      },
      {
        title: "磐田市「市営墓地」",
        url: "https://www.city.iwata.shizuoka.jp/kurashi_tetsuzuki/juutaku_pet_seikatsu/bochi/1001525.html",
        note: "市営墓地の使用・承継・改葬申請を確認する公式ページ。",
      },
      {
        title: "ATAWI TEMPLE 編集方針",
        url: "/editorial-policy/",
        note: "宗派・法務の判断を断定せず、確認先を示す掲載基準。",
      },
    ],
    bridgeLinks: [
      { label: "墓じまい前に確認すること", href: "/guide/haka-enpo/" },
  ...
  {
    slug: "eitaikuyo",
    title: "永代供養を考える前に確認したい親族・菩提寺・実家のこと",
    subtitle: "費用や納骨先の前に、家族の合意、菩提寺、仏壇、実家の行き先を整理します。",
    description: "磐田市で永代供養を考える前に、親族の合意、菩提寺との関係、墓地・仏壇・位牌、実家の管理や不動産確認を整理します。",
    category: "供養",
    updated: "2026-07-20",
    priority: "P0",
    sections: [
      {
        heading: "永代供養は、家族の確認を省くものではありません",
        paragraphs: [
          "永代供養は、寺院や霊園が一定の条件で供養・管理を引き受ける仕組みとして案内されます。ただし、納骨方法、合祀の時期、費用、管理期間、法要の扱いは場所によって異なります。",
          "承継者がいない、子どもが遠方に住んでいる、墓地を守り続けるのが難しい場合の選択肢ですが、家族の確認や菩提寺への相談を省けるわけではありません。",
        ],
      },
      {
        heading: "費用の前に確認する項目",
        paragraphs: [
          ...
          "磐田市内で公開情報が確認できる寺院・霊園についても、このサイトでは特定寺院の推奨は行いません。各寺院の公式情報、契約書、現地確認を優先してください。",
        ],
        bullets: [
          "個別安置期間と合祀の有無",
          "費用に含まれるものと含まれないもの",
      ...
      {
        heading: "菩提寺がある場合は、関係を確認する",
        paragraphs: [
          "菩提寺がある場合、永代供養を別の場所で進める前に、現在の寺院との関係を確認します。過去の法要、墓地、檀家関係、親族の意向を分けて整理してください。",
          "菩提寺名が分からない場合は、仏壇、過去帳、寺からの封筒、墓地の場所、親族の記憶から順番に確認します。",
        ],
        cta: {
      ...
      {
        heading: "実家の管理も同じ時期に確認する",
        paragraphs: [
          "永代供養を考える時期は、親の入院、施設入居、相続、空き家化と重なることがあります。家の中に仏壇や位牌が残る場合、実家をどう管理するかも同時に課題になります。",
          "住所から分かる名義、接道、土地の範囲、災害リスク、空き家管理の負担は、供養とは別に整理しておくと家族で話しやすくなります。",
        ],
        cta: {
          label: "実家・お墓まわりの確認だけ相談する",
          href: fromTempleUrl("eitaikuyo_check"),
          event: "to_fudosan_click",
          note: "査定ではありません。永代供養を考える前に、仏壇・実家・土地資料を分けて確認するための入口です。",
          external: true,
        },
        note: "運営元の不動産サービスへ移動します。掲載寺院との提携・紹介関係はありません。",
      },
    ...
    faq: [
      ...
      {
        question: "実家に仏壇や位牌が残っている場合はどうすればよいですか。",
        answer: "永代供養の契約とは別に、仏壇、位牌、過去帳、遺影、実家の管理を家族で整理します。処分や移動を急がず、親族の意向を確認してください。",
      },
    ],
    sources: [
      {
...
export const publicGuideArticles = guideArticles.map((article) => ({
  ...
  sections: article.sections.map((section) => ({
    ...
    paragraphs: section.paragraphs.map((paragraph) =>
      paragraph.includes("富士ヶ丘サービス")
        ? "実家については、売る・残すを急いで決めず、家族が把握している現状と確認が必要なことを先に整理します。"
        : paragraph
    ),
    cta: section.cta?.external
      ? {
          ...section.cta,
          label: "実家カルテ（無料ツール）に記録する",
          href: "/jikka-karute/",
          event: "jikka_karute_click",
          external: false,
          note: "売却や査定を前提にせず、家族で現状を共有するための記録です。入力内容は端末内だけに保存されます。",
        }
      : section.cta,
  })),
  bridgeLinks: article.bridgeLinks.map((link) =>
    link.href.startsWith(FUDOSAN_FROM_TEMPLE_URL)
      ? { label: "実家カルテ（無料ツール）を開く", href: "/jikka-karute/", event: "jikka_karute_click" }
      : link
  ),
}));
