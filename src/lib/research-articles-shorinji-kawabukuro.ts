...
const patronageTexts = [
  ...
  "郡誌は松林寺が今川氏の祈願所であったと伝える。祈願所という語は、祈祷命令、寺領安堵、軍事・領国安全の祈願、守護との帰依関係など異なる制度・実践を含み得る。1560年今川氏真判物写が寺領を扱うことは今川氏との直接関係を示すが、それだけで祈願内容や祈願所制度を証明しない。判物全文に祈願、祈祷、寺家、庵主などの語があるか、別文書に祈願命令・巻数・札・護摩・読経の記載があるかを調べる。郡誌の祈願所説明が寺伝由来なら、最古の由緒書と後世の編纂過程を追う。今川氏一般の寺社方針を比較枠に用いても、他寺の祈願内容を松林寺へ移さない。外護と所領安堵を区別することが、政治権力と地域寺院の関係を具体化する。",
